...
import { CheckCircle2, Calculator, Bolt } from "lucide-react";
...
export function CTA() {
  ...
  return (
    <section className="cta-section relative py-32 bg-primary text-white text-center overflow-hidden">
      {ctaBg && (
        <div className="absolute inset-0 z-0 opacity-20 animate-slow-zoom">
          <Image
            src={ctaBg.imageUrl}
      ...
      <div className="container mx-auto px-4 md:px-8 relative z-10">
        <div className="cta-wrapper max-w-[800px] mx-auto border border-white/10 p-8 md:p-16 bg-gradient-to-br from-primary/80 to-[#0f172a]/90 backdrop-blur-md rounded-[20px] shadow-[inset_0_0_50px_rgba(0,0,0,0.5)] transition-all duration-500 hover:-translate-y-1 hover:shadow-[inset_0_0_50px_rgba(0,0,0,0.5),0_25px_50px_rgba(0,0,0,0.4)]">
          ...
          <h2 className="text-white my-6 font-headline text-3xl md:text-[3.5rem]">¿Listo para escalar la logística de tu E-Commerce?</h2>
          <p className="text-white text-base md:text-[1.2rem] mb-10 opacity-90">Olvidate de la gestión de paquetes y enfocate en vender más. Dejá la distribución urbana en manos de expertos.</p>
          
          <div className="flex flex-wrap justify-center gap-6 mb-12">
            <a href="https://api.whatsapp.com/send/?phone=5492236602699" target="_blank" className="btn btn-primary min-h-[44px]">
               Contactanos por WhatsApp
            </a>
            <a href="/tarifas" className="btn btn-secondary min-h-[44px]">
